...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Behavior.ontology_term'
        db.add_column(u'feed_behavior', 'ontology_term',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['feed.BehaviorOwl']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Behavior.ontology_term'
        db.delete_column(u'feed_behavior', 'ontology_term_id')
