...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sensor.location_freetext'
        db.delete_column(u'feed_sensor', 'location_freetext')


    def backwards(self, orm):
        # Adding field 'Sensor.location_freetext'
        db.add_column(u'feed_sensor', 'location_freetext',
