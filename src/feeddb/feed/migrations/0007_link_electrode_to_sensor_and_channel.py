...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmgElectrode.channel'
        db.add_column('feed_emgelectrode', 'channel', orm['feed.emgelectrode:channel'])
        
        # Adding field 'EmgElectrode.sensor'
        db.add_column('feed_emgelectrode', 'sensor', orm['feed.emgelectrode:sensor'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'EmgElectrode.channel'
        db.delete_column('feed_emgelectrode', 'channel_id')
        
        # Deleting field 'EmgElectrode.sensor'
        db.delete_column('feed_emgelectrode', 'sensor_id')
    ...
    models = {
        ...
        'feed.emgchannel': {
            ...
            'emg_amplification': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        'feed.emgelectrode': {
            ...
            'channel': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['feed.EmgChannel']", 'unique': 'True', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'rate': ('django.db.models.fields.IntegerField', [], {}),
            'sensor': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['feed.EmgSensor']", 'unique': 'True', 'null': 'True'}),
            'setup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Setup']"}),
