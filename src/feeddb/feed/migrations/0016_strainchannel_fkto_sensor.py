...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StrainChannel.sensor'
        db.add_column('feed_strainchannel', 'sensor', orm['feed.strainchannel:sensor'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'StrainChannel.sensor'
        db.delete_column('feed_strainchannel', 'sensor_id')
