...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EmgChannel.emg_unit'
        db.delete_column('feed_emgchannel', 'emg_unit_id')
        
        # Deleting field 'SonoChannel.sono_unit'
        db.delete_column('feed_sonochannel', 'sono_unit_id')
        
        # Changing field 'EmgChannel.unit'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Unit']))
        db.alter_column('feed_emgchannel', 'unit_id', orm['feed.emgchannel:unit'])
        
        # Changing field 'SonoChannel.unit'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Unit']))
        db.alter_column('feed_sonochannel', 'unit_id', orm['feed.sonochannel:unit'])
        
    
    
    def backwards(self, orm):
        
        # Adding field 'EmgChannel.emg_unit'
        db.add_column('feed_emgchannel', 'emg_unit', orm['feed.emgchannel:emg_unit'])
        
        # Adding field 'SonoChannel.sono_unit'
        db.add_column('feed_sonochannel', 'sono_unit', orm['feed.sonochannel:sono_unit'])
        
        # Changing field 'EmgChannel.unit'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Unit'], null=True))
        db.alter_column('feed_emgchannel', 'unit_id', orm['feed.emgchannel:unit'])
