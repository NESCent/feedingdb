...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trial.behavior_primary'
        db.alter_column(u'feed_trial', 'behavior_primary_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Behavior'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Trial.behavior_primary'
        raise RuntimeError("Cannot reverse this migration. 'Trial.behavior_primary' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Trial.behavior_primary'
        db.alter_column(u'feed_trial', 'behavior_primary_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Behavior']))
