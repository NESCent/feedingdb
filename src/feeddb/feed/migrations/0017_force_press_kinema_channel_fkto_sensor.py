...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KinematicsChannel.sensor'
        db.add_column('feed_kinematicschannel', 'sensor', orm['feed.kinematicschannel:sensor'])
        
        # Adding field 'ForceChannel.sensor'
        db.add_column('feed_forcechannel', 'sensor', orm['feed.forcechannel:sensor'])
        
        # Adding field 'PressureChannel.sensor'
        db.add_column('feed_pressurechannel', 'sensor', orm['feed.pressurechannel:sensor'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'KinematicsChannel.sensor'
        db.delete_column('feed_kinematicschannel', 'sensor_id')
        
        # Deleting field 'ForceChannel.sensor'
        db.delete_column('feed_forcechannel', 'sensor_id')
        
        # Deleting field 'PressureChannel.sensor'
        db.delete_column('feed_pressurechannel', 'sensor_id')
