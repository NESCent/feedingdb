...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StrainSensor.anatomical_location_text'
        db.add_column(u'feed_strainsensor', 'anatomical_location_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PressureSensor.location_text'
        db.add_column(u'feed_pressuresensor', 'location_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'ForceSensor.location_text'
        db.add_column(u'feed_forcesensor', 'location_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'KinematicsSensor.anatomical_location_text'
        db.add_column(u'feed_kinematicssensor', 'anatomical_location_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StrainSensor.anatomical_location_text'
        db.delete_column(u'feed_strainsensor', 'anatomical_location_text')

        # Deleting field 'PressureSensor.location_text'
        db.delete_column(u'feed_pressuresensor', 'location_text')

        # Deleting field 'ForceSensor.location_text'
        db.delete_column(u'feed_forcesensor', 'location_text')

        # Deleting field 'KinematicsSensor.anatomical_location_text'
        db.delete_column(u'feed_kinematicssensor', 'anatomical_location_text')
