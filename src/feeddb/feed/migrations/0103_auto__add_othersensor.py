...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OtherSensor'
        db.create_table(u'feed_othersensor', (
            (u'sensor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['feed.Sensor'], unique=True, primary_key=True)),
            ('location_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ))
        db.send_create_signal(u'feed', ['OtherSensor'])

        # Adding field 'OtherChannel.sensor'
        db.add_column(u'feed_otherchannel', 'sensor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.OtherSensor'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OtherSensor'
        db.delete_table(u'feed_othersensor')

        # Deleting field 'OtherChannel.sensor'
        db.delete_column(u'feed_otherchannel', 'sensor_id')
