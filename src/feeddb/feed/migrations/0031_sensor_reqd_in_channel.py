...
#Before applying this migration forward, use SQL queries like these to detect experiments 
# that contain sensor-less channels:  
#  select s.experiment_id, x.*
#  from feed_setup s, feed_channel c, feed_kinematicschannel x
#  where s.id = c.setup_id
#    and c.id = x.channel_ptr_id
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PressureChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.PressureSensor']))
        db.alter_column('feed_pressurechannel', 'sensor_id', orm['feed.pressurechannel:sensor'])
        
        # Changing field 'StrainChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.StrainSensor']))
        db.alter_column('feed_strainchannel', 'sensor_id', orm['feed.strainchannel:sensor'])
        
        # Changing field 'ForceChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.ForceSensor']))
        db.alter_column('feed_forcechannel', 'sensor_id', orm['feed.forcechannel:sensor'])
        
        # Changing field 'KinematicsChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.KinematicsSensor']))
        db.alter_column('feed_kinematicschannel', 'sensor_id', orm['feed.kinematicschannel:sensor'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PressureChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.PressureSensor'], null=True, blank=True))
        db.alter_column('feed_pressurechannel', 'sensor_id', orm['feed.pressurechannel:sensor'])
        
        # Changing field 'StrainChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.StrainSensor'], null=True, blank=True))
        db.alter_column('feed_strainchannel', 'sensor_id', orm['feed.strainchannel:sensor'])
        
        # Changing field 'ForceChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.ForceSensor'], null=True, blank=True))
        db.alter_column('feed_forcechannel', 'sensor_id', orm['feed.forcechannel:sensor'])
        
        # Changing field 'KinematicsChannel.sensor'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.KinematicsSensor'], null=True, blank=True))
        db.alter_column('feed_kinematicschannel', 'sensor_id', orm['feed.kinematicschannel:sensor'])
