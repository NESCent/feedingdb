...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OtherChannel'
        db.create_table(u'feed_otherchannel', (
            (u'channel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['feed.Channel'], unique=True, primary_key=True)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'feed', ['OtherChannel'])

        # Adding model 'OtherSetup'
        db.create_table(u'feed_othersetup', (
            (u'setup_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['feed.Setup'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'feed', ['OtherSetup'])


    def backwards(self, orm):
        # Deleting model 'OtherChannel'
        db.delete_table(u'feed_otherchannel')

        # Deleting model 'OtherSetup'
        db.delete_table(u'feed_othersetup')
