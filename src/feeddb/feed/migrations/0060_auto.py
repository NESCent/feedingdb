...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field bfo_part_of_some on 'MuscleOwl'
        m2m_table_name = db.shorten_name(u'feed_muscleowl_bfo_part_of_some')
        ...
        # Adding M2M table for field bfo_part_of_some on 'BehaviorOwl'
        m2m_table_name = db.shorten_name(u'feed_behaviorowl_bfo_part_of_some')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field bfo_part_of_some on 'MuscleOwl'
        db.delete_table(db.shorten_name(u'feed_muscleowl_bfo_part_of_some'))

        # Removing M2M table for field bfo_part_of_some on 'BehaviorOwl'
        db.delete_table(db.shorten_name(u'feed_behaviorowl_bfo_part_of_some'))
