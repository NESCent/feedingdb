...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trial.accession'
        db.delete_column(u'feed_trial', 'accession')

        # Deleting field 'Session.accession'
        db.delete_column(u'feed_session', 'accession')

        # Deleting field 'Experiment.accession'
        db.delete_column(u'feed_experiment', 'accession')


    def backwards(self, orm):
        # Adding field 'Trial.accession'
        db.add_column(u'feed_trial', 'accession',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Session.accession'
        db.add_column(u'feed_session', 'accession',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.accession'
        db.add_column(u'feed_experiment', 'accession',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
