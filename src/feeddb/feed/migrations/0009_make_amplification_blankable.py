...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmgChannel.emg_amplification'
        # (to signature: django.db.models.fields.IntegerField(null=True, blank=True))
        db.alter_column('feed_emgchannel', 'emg_amplification', orm['feed.emgchannel:emg_amplification'])
        
        # Changing field 'EmgElectrode.emg_amplification'
        # (to signature: django.db.models.fields.IntegerField(null=True, blank=True))
        db.alter_column('feed_emgelectrode', 'emg_amplification', orm['feed.emgelectrode:emg_amplification'])
