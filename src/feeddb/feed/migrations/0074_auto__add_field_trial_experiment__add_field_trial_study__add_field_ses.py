...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trial.experiment'
        db.add_column(u'feed_trial', 'experiment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Experiment'], null=True),
                      keep_default=False)

        # Adding field 'Trial.study'
        db.add_column(u'feed_trial', 'study',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Study'], null=True),
                      keep_default=False)

        # Adding field 'Session.study'
        db.add_column(u'feed_session', 'study',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Study'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trial.experiment'
        db.delete_column(u'feed_trial', 'experiment_id')

        # Deleting field 'Trial.study'
        db.delete_column(u'feed_trial', 'study_id')

        # Deleting field 'Session.study'
        db.delete_column(u'feed_session', 'study_id')
    ...
    models = {
        ...
        u'feed.trial': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.Experiment']", 'null': 'True'}),
