...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ForceSensor'
        db.create_table('feed_forcesensor', (
            ('sensor_ptr', orm['feed.forcesensor:sensor_ptr']),
        ))
        db.send_create_signal('feed', ['ForceSensor'])
        
        # Adding model 'KinematicsSetup'
        db.create_table('feed_kinematicssetup', (
            ('setup_ptr', orm['feed.kinematicssetup:setup_ptr']),
        ))
        db.send_create_signal('feed', ['KinematicsSetup'])
        
        # Adding model 'PressureChannel'
        db.create_table('feed_pressurechannel', (
            ('channel_ptr', orm['feed.pressurechannel:channel_ptr']),
        ))
        db.send_create_signal('feed', ['PressureChannel'])
        
        # Adding model 'ForceSetup'
        db.create_table('feed_forcesetup', (
            ('setup_ptr', orm['feed.forcesetup:setup_ptr']),
        ))
        db.send_create_signal('feed', ['ForceSetup'])
        
        # Adding model 'KinematicsSensor'
        db.create_table('feed_kinematicssensor', (
            ('sensor_ptr', orm['feed.kinematicssensor:sensor_ptr']),
        ))
        db.send_create_signal('feed', ['KinematicsSensor'])
        
        # Adding model 'KinematicsChannel'
        db.create_table('feed_kinematicschannel', (
            ('channel_ptr', orm['feed.kinematicschannel:channel_ptr']),
        ))
        db.send_create_signal('feed', ['KinematicsChannel'])
        
        # Adding model 'PressureSetup'
        db.create_table('feed_pressuresetup', (
            ('setup_ptr', orm['feed.pressuresetup:setup_ptr']),
        ))
        db.send_create_signal('feed', ['PressureSetup'])
        
        # Adding model 'PressureSensor'
        db.create_table('feed_pressuresensor', (
            ('sensor_ptr', orm['feed.pressuresensor:sensor_ptr']),
        ))
        db.send_create_signal('feed', ['PressureSensor'])
        
        # Adding model 'ForceChannel'
        db.create_table('feed_forcechannel', (
            ('channel_ptr', orm['feed.forcechannel:channel_ptr']),
        ))
        db.send_create_signal('feed', ['ForceChannel'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'ForceSensor'
        db.delete_table('feed_forcesensor')
        
        # Deleting model 'KinematicsSetup'
        db.delete_table('feed_kinematicssetup')
        
        # Deleting model 'PressureChannel'
        db.delete_table('feed_pressurechannel')
        
        # Deleting model 'ForceSetup'
        db.delete_table('feed_forcesetup')
        
        # Deleting model 'KinematicsSensor'
        db.delete_table('feed_kinematicssensor')
        
        # Deleting model 'KinematicsChannel'
        db.delete_table('feed_kinematicschannel')
        
        # Deleting model 'PressureSetup'
        db.delete_table('feed_pressuresetup')
        
        # Deleting model 'PressureSensor'
        db.delete_table('feed_pressuresensor')
        
        # Deleting model 'ForceChannel'
        db.delete_table('feed_forcechannel')
    ...
    models = {
        ...
        'feed.channel': {
            ...
            'units': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Unit']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
        },
        'feed.channellineup': {
