...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feed_trial', 'end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Trial.start'
        db.alter_column(u'feed_trial', 'start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Session.start'
        db.alter_column(u'feed_session', 'start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Session.end'
        db.alter_column(u'feed_session', 'end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Experiment.end'
        db.alter_column(u'feed_experiment', 'end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Experiment.start'
        db.alter_column(u'feed_experiment', 'start', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Trial.end'
        db.alter_column(u'feed_trial', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Trial.start'
        db.alter_column(u'feed_trial', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Session.start'
        db.alter_column(u'feed_session', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Session.end'
        db.alter_column(u'feed_session', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Experiment.end'
        db.alter_column(u'feed_experiment', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Experiment.start'
        db.alter_column(u'feed_experiment', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))
