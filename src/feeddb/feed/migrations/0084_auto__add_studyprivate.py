...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feed_studyprivate', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='studyprivate_related', null=True, to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('study', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['feed.Study'], unique=True)),
            ('pi', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
