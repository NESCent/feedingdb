...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.technique'
        db.delete_column('feed_unit', 'technique_id')
        
        # Deleting field 'Setup.technique'
        db.delete_column('feed_setup', 'technique_id')
        
        # Deleting model 'technique'
        db.delete_table('feed_technique')
        
        # Changing field 'Setup.techn_enum'
        # (to signature: django.db.models.fields.IntegerField())
        db.alter_column('feed_setup', 'techn_enum', orm['feed.setup:techn_enum'])
        
        # Changing field 'Unit.techn_enum'
        # (to signature: django.db.models.fields.IntegerField())
        db.alter_column('feed_unit', 'techn_enum', orm['feed.unit:techn_enum'])
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Unit.technique'
        db.add_column('feed_unit', 'technique', orm['feed.unit:technique'])
        
        # Adding field 'Setup.technique'
        db.add_column('feed_setup', 'technique', orm['feed.setup:technique'])
    ...
    models = {
        ...
        'feed.setup': {
            ...
            'techn_enum': ('django.db.models.fields.IntegerField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
        },
        'feed.side': {
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
