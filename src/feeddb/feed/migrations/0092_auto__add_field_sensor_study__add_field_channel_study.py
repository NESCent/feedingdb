...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sensor.study'
        db.add_column(u'feed_sensor', 'study',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Study'], null=True),
                      keep_default=False)

        # Adding field 'Channel.study'
        db.add_column(u'feed_channel', 'study',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Study'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sensor.study'
        db.delete_column(u'feed_sensor', 'study_id')

        # Deleting field 'Channel.study'
        db.delete_column(u'feed_channel', 'study_id')
