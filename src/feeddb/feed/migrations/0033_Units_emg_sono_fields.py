...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmgChannel.unit'
        db.add_column('feed_emgchannel', 'unit', orm['feed.emgchannel:unit'])
        
        # Adding field 'SonoChannel.unit'
        db.add_column('feed_sonochannel', 'unit', orm['feed.sonochannel:unit'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'EmgChannel.unit'
        db.delete_column('feed_emgchannel', 'unit_id')
        
        # Deleting field 'SonoChannel.unit'
        db.delete_column('feed_sonochannel', 'unit_id')
