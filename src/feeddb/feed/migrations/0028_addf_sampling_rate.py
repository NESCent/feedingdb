...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setup.sampling_rate'
        db.add_column('feed_setup', 'sampling_rate', orm['feed.setup:sampling_rate'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Setup.sampling_rate'
        db.delete_column('feed_setup', 'sampling_rate')
