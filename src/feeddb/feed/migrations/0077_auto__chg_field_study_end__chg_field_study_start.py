...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Study.end'
        db.alter_column(u'feed_study', 'end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Study.start'
        db.alter_column(u'feed_study', 'start', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Study.end'
        db.alter_column(u'feed_study', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Study.start'
        db.alter_column(u'feed_study', 'start', self.gf('django.db.models.fields.DateTimeField')())
