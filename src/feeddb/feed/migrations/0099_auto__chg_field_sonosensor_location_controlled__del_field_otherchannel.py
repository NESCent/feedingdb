...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feed_sonosensor', 'location_controlled_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.AnatomicalLocation'], null=True))
        # Deleting field 'OtherChannel.unit'
        db.delete_column(u'feed_otherchannel', 'unit')


        # Changing field 'EmgSensor.location_controlled'
        db.alter_column(u'feed_emgsensor', 'location_controlled_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.AnatomicalLocation'], null=True))

    def backwards(self, orm):

        # Changing field 'SonoSensor.location_controlled'
        db.alter_column(u'feed_sonosensor', 'location_controlled_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['feed.AnatomicalLocation']))
        # Adding field 'OtherChannel.unit'
        db.add_column(u'feed_otherchannel', 'unit',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'EmgSensor.location_controlled'
        db.alter_column(u'feed_emgsensor', 'location_controlled_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['feed.AnatomicalLocation']))
