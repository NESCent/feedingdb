...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trial.estimated_duration'
        db.add_column('feed_trial', 'estimated_duration', orm['feed.trial:estimated_duration'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Trial.estimated_duration'
        db.delete_column('feed_trial', 'estimated_duration')
