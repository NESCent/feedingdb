...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Setup.techn_enum'
        db.delete_column('feed_setup', 'techn_enum')
        
        # Deleting field 'Unit.techn_enum'
        db.delete_column('feed_unit', 'techn_enum')
        
        # Changing field 'Setup.technique'
        # (to signature: django.db.models.fields.IntegerField())
        db.alter_column('feed_setup', 'technique', orm['feed.setup:technique'])
        
        # Changing field 'Unit.technique'
        # (to signature: django.db.models.fields.IntegerField())
        db.alter_column('feed_unit', 'technique', orm['feed.unit:technique'])
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Setup.techn_enum'
        db.add_column('feed_setup', 'techn_enum', orm['feed.setup:techn_enum'])
        
        # Adding field 'Unit.techn_enum'
        db.add_column('feed_unit', 'techn_enum', orm['feed.unit:techn_enum'])
