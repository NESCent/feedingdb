...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnimalApprovalType'
        db.create_table(u'feed_animalapprovaltype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='animalapprovaltype_related', null=True, to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'feed', ['AnimalApprovalType'])

        # Deleting field 'Study.approval_secured'
        db.delete_column(u'feed_study', 'approval_secured')

        # Adding M2M table for field approval_type on 'Study'
        m2m_table_name = db.shorten_name(u'feed_study_approval_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('study', models.ForeignKey(orm[u'feed.study'], null=False)),
            ('animalapprovaltype', models.ForeignKey(orm[u'feed.animalapprovaltype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['study_id', 'animalapprovaltype_id'])


    def backwards(self, orm):
        # Deleting model 'AnimalApprovalType'
        db.delete_table(u'feed_animalapprovaltype')

        # Adding field 'Study.approval_secured'
        db.add_column(u'feed_study', 'approval_secured',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field approval_type on 'Study'
        db.delete_table(db.shorten_name(u'feed_study_approval_type'))
    ...
    models = {
        ...
        u'feed.study': {
            ...
            'approval_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['feed.AnimalApprovalType']", 'null': 'True', 'symmetrical': 'False'}),
            'bookkeeping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
