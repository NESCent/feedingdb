...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MuscleOwl.rdfs_is_class'
        db.add_column(u'feed_muscleowl', 'rdfs_is_class',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BehaviorOwl.rdfs_is_class'
        db.add_column(u'feed_behaviorowl', 'rdfs_is_class',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MuscleOwl.rdfs_is_class'
        db.delete_column(u'feed_muscleowl', 'rdfs_is_class')

        # Deleting field 'BehaviorOwl.rdfs_is_class'
        db.delete_column(u'feed_behaviorowl', 'rdfs_is_class')
