...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedUserProfile'
        db.create_table(u'feed_feeduserprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('institutional_affiliation', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'feed', ['FeedUserProfile'])


    def backwards(self, orm):
        # Deleting model 'FeedUserProfile'
        db.delete_table(u'feed_feeduserprofile')
