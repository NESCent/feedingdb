...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StrainSensor.gage_type'
        db.add_column(u'feed_strainsensor', 'gage_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Experiment.subj_age'
        db.alter_column(u'feed_experiment', 'subj_age', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=1))

        # Changing field 'Experiment.subj_weight'
        db.alter_column(u'feed_experiment', 'subj_weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'StrainSensor.gage_type'
        db.delete_column(u'feed_strainsensor', 'gage_type')


        # Changing field 'Experiment.subj_age'
        db.alter_column(u'feed_experiment', 'subj_age', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=5))

        # Changing field 'Experiment.subj_weight'
        db.alter_column(u'feed_experiment', 'subj_weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=5))
    ...
    models = {
        ...
        u'feed.behavior': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ontology_term': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['feed.BehaviorOwl']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'feed.behaviorowl': {
            ...
            'synonyms_comma_separated': ('django.db.models.fields.CharField', [], {'max_length': '1500', 'null': 'True'}),
        ...
        u'feed.channel': {
            ...
            'study': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.Study']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
        },
        ...
        u'feed.emgsensor': {
            ...
            'location_controlled': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.AnatomicalLocation']", 'null': 'True'}),
        ...
        u'feed.experiment': {
            ...
            'subj_age': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '1', 'blank': 'True'}),
            ...
            'subj_weight': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2', 'blank': 'True'}),
        ...
        u'feed.feeduserprofile': {
            ...
            'institutional_affiliation': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'feed.forcesensor': {
            ...
            'location_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            u'sensor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Sensor']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'feed.forcesetup': {
        ...
        u'feed.kinematicssensor': {
            ...
            'anatomical_location_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            u'sensor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Sensor']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        u'feed.otherchannel': {
            'Meta': {'object_name': 'OtherChannel', '_ormbases': [u'feed.Channel']},
            u'channel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Channel']", 'unique': 'True', 'primary_key': 'True'}),
            'sensor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.OtherSensor']", 'null': 'True'})
        },
        u'feed.othersensor': {
            'Meta': {'object_name': 'OtherSensor', '_ormbases': [u'feed.Sensor']},
            'location_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            u'sensor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Sensor']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'feed.othersetup': {
            'Meta': {'object_name': 'OtherSetup', '_ormbases': [u'feed.Setup']},
            u'setup_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Setup']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        u'feed.strainsensor': {
            ...
            'anatomical_location_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'gage_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'sensor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Sensor']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'feed.strainsetup': {
        ...
        u'feed.trial': {
            ...
            'behavior_primary': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.Behavior']", 'null': 'True', 'blank': 'True'}),
            'behavior_secondary': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'behaviorowl_primary': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'primary_in_trials'", 'null': 'True', 'to': u"orm['feed.BehaviorOwl']"}),
            'bookkeeping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
