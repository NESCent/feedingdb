...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Study.approval_type'
        db.add_column(u'feed_study', 'approval_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.AnimalApprovalType'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Study.approval_type'
        db.delete_column(u'feed_study', 'approval_type_id')
