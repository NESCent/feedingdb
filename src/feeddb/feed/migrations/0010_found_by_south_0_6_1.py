...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmgElectrode.sensor'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['feed.Sensor'], unique=True, null=True, blank=True))
        db.alter_column('feed_emgelectrode', 'sensor_id', orm['feed.emgelectrode:sensor'])
        
        # Changing field 'EmgElectrode.channel'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['feed.Channel'], unique=True, null=True, blank=True))
        db.alter_column('feed_emgelectrode', 'channel_id', orm['feed.emgelectrode:channel'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EmgElectrode.sensor'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['feed.EmgSensor'], unique=True, null=True))
        db.alter_column('feed_emgelectrode', 'sensor_id', orm['feed.emgelectrode:sensor'])
        
        # Changing field 'EmgElectrode.channel'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['feed.EmgChannel'], unique=True, null=True))
        db.alter_column('feed_emgelectrode', 'channel_id', orm['feed.emgelectrode:channel'])
