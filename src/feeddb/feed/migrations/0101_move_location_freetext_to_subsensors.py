...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for sensor in orm.StrainSensor.objects.all():
            sensor.anatomical_location_text = sensor.location_freetext
        for sensor in orm.KinematicsSensor.objects.all():
            sensor.anatomical_location_text = sensor.location_freetext

        for sensor in orm.ForceSensor.objects.all():
            sensor.location_text = sensor.location_freetext
        for sensor in orm.PressureSensor.objects.all():
            sensor.location_text = sensor.location_freetext

    def backwards(self, orm):
        for sensor in orm.StrainSensor.objects.all():
            sensor.location_freetext = sensor.anatomical_location_text
        for sensor in orm.KinematicsSensor.objects.all():
            sensor.location_freetext = sensor.anatomical_location_text

        for sensor in orm.ForceSensor.objects.all():
            sensor.location_freetext = sensor.location_text
        for sensor in orm.PressureSensor.objects.all():
            sensor.location_freetext = sensor.location_text
