...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MuscleOwl'
        db.create_table(u'feed_muscleowl', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('obo_definition', self.gf('django.db.models.fields.TextField')()),
            ('rdfs_comment', self.gf('django.db.models.fields.TextField')()),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=1500)),
        ))
        db.send_create_signal(u'feed', ['MuscleOwl'])

        # Adding M2M table for field rdfs_subClassOf_ancestors on 'MuscleOwl'
        m2m_table_name = db.shorten_name(u'feed_muscleowl_rdfs_subClassOf_ancestors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_muscleowl', models.ForeignKey(orm[u'feed.muscleowl'], null=False)),
            ('to_muscleowl', models.ForeignKey(orm[u'feed.muscleowl'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_muscleowl_id', 'to_muscleowl_id'])

        # Adding model 'BehaviorOwl'
        db.create_table(u'feed_behaviorowl', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('obo_definition', self.gf('django.db.models.fields.TextField')()),
            ('rdfs_comment', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'feed', ['BehaviorOwl'])

        # Adding M2M table for field rdfs_subClassOf_ancestors on 'BehaviorOwl'
        m2m_table_name = db.shorten_name(u'feed_behaviorowl_rdfs_subClassOf_ancestors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_behaviorowl', models.ForeignKey(orm[u'feed.behaviorowl'], null=False)),
            ('to_behaviorowl', models.ForeignKey(orm[u'feed.behaviorowl'], null=False))
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'MuscleOwl'
        db.delete_table(u'feed_muscleowl')

        # Removing M2M table for field rdfs_subClassOf_ancestors on 'MuscleOwl'
        db.delete_table(db.shorten_name(u'feed_muscleowl_rdfs_subClassOf_ancestors'))

        # Deleting model 'BehaviorOwl'
        db.delete_table(u'feed_behaviorowl')

        # Removing M2M table for field rdfs_subClassOf_ancestors on 'BehaviorOwl'
        db.delete_table(db.shorten_name(u'feed_behaviorowl_rdfs_subClassOf_ancestors'))

        # Adding M2M table for field channels on 'session'
        m2m_table_name = db.shorten_name(u'feed_session_channels')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('session', models.ForeignKey(orm['feed.session'], null=False)),
            ('channel', models.ForeignKey(orm['feed.channel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['session_id', 'channel_id'])
