...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trial.data_file'
        db.add_column('feed_trial', 'data_file', orm['feed.trial:data_file'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Trial.data_file'
        db.delete_column('feed_trial', 'data_file')
