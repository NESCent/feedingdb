...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AgeUnit'
        db.create_table('feed_ageunit', (
            ('id', orm['feed.ageunit:id']),
            ('created_by', orm['feed.ageunit:created_by']),
            ('created_at', orm['feed.ageunit:created_at']),
            ('updated_at', orm['feed.ageunit:updated_at']),
            ('label', orm['feed.ageunit:label']),
        ))
        db.send_create_signal('feed', ['AgeUnit'])
        
        # Adding field 'Experiment.subj_ageunit'
        db.add_column('feed_experiment', 'subj_ageunit', orm['feed.experiment:subj_ageunit'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'AgeUnit'
        db.delete_table('feed_ageunit')
        
        # Deleting field 'Experiment.subj_ageunit'
        db.delete_column('feed_experiment', 'subj_ageunit_id')
