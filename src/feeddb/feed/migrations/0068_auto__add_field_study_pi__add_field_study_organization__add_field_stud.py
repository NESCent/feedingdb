...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Study.pi'
        db.add_column(u'feed_study', 'pi',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Study.organization'
        db.add_column(u'feed_study', 'organization',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Study.lab'
        db.add_column(u'feed_study', 'lab',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Study.funding'
        db.add_column(u'feed_study', 'funding',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Study.approval'
        db.add_column(u'feed_study', 'approval',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Study.pi'
        db.delete_column(u'feed_study', 'pi')

        # Deleting field 'Study.organization'
        db.delete_column(u'feed_study', 'organization')

        # Deleting field 'Study.lab'
        db.delete_column(u'feed_study', 'lab')

        # Deleting field 'Study.funding'
        db.delete_column(u'feed_study', 'funding')

        # Deleting field 'Study.approval'
        db.delete_column(u'feed_study', 'approval')
