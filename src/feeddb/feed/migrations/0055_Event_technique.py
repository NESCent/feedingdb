...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventSetup'
        db.create_table('feed_eventsetup', (
            ('setup_ptr', orm['feed.eventsetup:setup_ptr']),
        ))
        db.send_create_signal('feed', ['EventSetup'])
        
        # Adding model 'EventChannel'
        db.create_table('feed_eventchannel', (
            ('channel_ptr', orm['feed.eventchannel:channel_ptr']),
            ('unit', orm['feed.eventchannel:unit']),
        ))
        db.send_create_signal('feed', ['EventChannel'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'EventSetup'
        db.delete_table('feed_eventsetup')
        
        # Deleting model 'EventChannel'
        db.delete_table('feed_eventchannel')
