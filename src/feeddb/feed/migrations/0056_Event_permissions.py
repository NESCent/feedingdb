...
class Migration:
    ...
    contributors_models = ["eventsetup", "eventchannel"]
    ...
    def backwards(self, orm):
        def remove_permissions(group_name, group_opers, group_models):
            group = orm['auth.Group'].objects.get(name__iexact=group_name)
        ...
        remove_permissions('contributors', Migration.contributors_opers, Migration.contributors_models)
