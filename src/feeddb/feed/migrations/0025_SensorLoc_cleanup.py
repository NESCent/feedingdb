...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SonoSensor.side'
        db.delete_column('feed_sonosensor', 'side_id')
        
        # Deleting field 'SonoSensor.axisap'
        db.delete_column('feed_sonosensor', 'axisap_id')
        
        # Deleting field 'Sensor.location'
        db.delete_column('feed_sensor', 'location')
        
        # Deleting field 'EmgSensor.axisdv'
        db.delete_column('feed_emgsensor', 'axisdv_id')
        
        # Deleting field 'AnatomicalLocation.tmp_muscleid'
        db.delete_column('feed_anatomicallocation', 'tmp_muscleid')
        
        # Deleting field 'SonoSensor.muscle'
        db.delete_column('feed_sonosensor', 'muscle_id')
        
        # Deleting field 'EmgSensor.axisap'
        db.delete_column('feed_emgsensor', 'axisap_id')
        
        # Deleting field 'EmgSensor.side'
        db.delete_column('feed_emgsensor', 'side_id')
        
        # Deleting field 'SonoSensor.axisdv'
        db.delete_column('feed_sonosensor', 'axisdv_id')
        
        # Deleting field 'EmgSensor.muscle'
        db.delete_column('feed_emgsensor', 'muscle_id')
        
        # Changing field 'SonoSensor.location_controlled'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.AnatomicalLocation']))
        db.alter_column('feed_sonosensor', 'location_controlled_id', orm['feed.sonosensor:location_controlled'])
        
        # Changing field 'Sensor.loc_side'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Side']))
        db.alter_column('feed_sensor', 'loc_side_id', orm['feed.sensor:loc_side'])
        
        # Changing field 'EmgSensor.location_controlled'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.AnatomicalLocation']))
        db.alter_column('feed_emgsensor', 'location_controlled_id', orm['feed.emgsensor:location_controlled'])
        
    
    
    def backwards(self, orm):
        "Note(VG): this auto-generated code restores the structures, but not the data that was there.  I.e., this migration is not fully reversible"
        # Adding field 'SonoSensor.side'
        db.add_column('feed_sonosensor', 'side', orm['feed.sonosensor:side'])
        
        # Adding field 'SonoSensor.axisap'
        db.add_column('feed_sonosensor', 'axisap', orm['feed.sonosensor:axisap'])
        
        # Adding field 'Sensor.location'
        db.add_column('feed_sensor', 'location', orm['feed.sensor:location'])
        
        # Adding field 'EmgSensor.axisdv'
        db.add_column('feed_emgsensor', 'axisdv', orm['feed.emgsensor:axisdv'])
        
        # Adding field 'AnatomicalLocation.tmp_muscleid'
        db.add_column('feed_anatomicallocation', 'tmp_muscleid', orm['feed.anatomicallocation:tmp_muscleid'])
        
        # Adding field 'SonoSensor.muscle'
        db.add_column('feed_sonosensor', 'muscle', orm['feed.sonosensor:muscle'])
        
        # Adding field 'EmgSensor.axisap'
        db.add_column('feed_emgsensor', 'axisap', orm['feed.emgsensor:axisap'])
        
        # Adding field 'EmgSensor.side'
        db.add_column('feed_emgsensor', 'side', orm['feed.emgsensor:side'])
        
        # Adding field 'SonoSensor.axisdv'
        db.add_column('feed_sonosensor', 'axisdv', orm['feed.sonosensor:axisdv'])
        
        # Adding field 'EmgSensor.muscle'
        db.add_column('feed_emgsensor', 'muscle', orm['feed.emgsensor:muscle'])
        
        # Changing field 'SonoSensor.location_controlled'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.AnatomicalLocation'], null=True))
        db.alter_column('feed_sonosensor', 'location_controlled_id', orm['feed.sonosensor:location_controlled'])
        
        # Changing field 'Sensor.loc_side'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Side'], null=True))
        db.alter_column('feed_sensor', 'loc_side_id', orm['feed.sensor:loc_side'])
