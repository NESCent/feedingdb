...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feed_sensor', 'loc_side_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Side'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Sensor.loc_side'
        raise RuntimeError("Cannot reverse this migration. 'Sensor.loc_side' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Sensor.loc_side'
        db.alter_column(u'feed_sensor', 'loc_side_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Side']))
