...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('feed', ['StrainSetup'])
        
        # Adding model 'Unit'
        db.create_table('feed_unit', (
            ('id', orm['feed.unit:id']),
            ('created_by', orm['feed.unit:created_by']),
            ('created_at', orm['feed.unit:created_at']),
            ('updated_at', orm['feed.unit:updated_at']),
            ('label', orm['feed.unit:label']),
            ('controlled', orm['feed.unit:controlled']),
            ('deprecated', orm['feed.unit:deprecated']),
            ('technique', orm['feed.unit:technique']),
        ))
        db.send_create_signal('feed', ['Unit'])
        
        # Adding model 'StrainSensor'
        db.create_table('feed_strainsensor', (
            ('sensor_ptr', orm['feed.strainsensor:sensor_ptr']),
        ))
        db.send_create_signal('feed', ['StrainSensor'])
        
        # Adding model 'StrainChannel'
        db.create_table('feed_strainchannel', (
            ('channel_ptr', orm['feed.strainchannel:channel_ptr']),
        ))
        db.send_create_signal('feed', ['StrainChannel'])
        
        # Adding field 'Sensor.loc_side'
        db.add_column('feed_sensor', 'loc_side', orm['feed.sensor:loc_side'])
        
        # Adding field 'Channel.units'
        db.add_column('feed_channel', 'units', orm['feed.channel:units'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'StrainSetup'
        db.delete_table('feed_strainsetup')
        
        # Deleting model 'Unit'
        db.delete_table('feed_unit')
        
        # Deleting model 'StrainSensor'
        db.delete_table('feed_strainsensor')
        
        # Deleting model 'StrainChannel'
        db.delete_table('feed_strainchannel')
        
        # Deleting field 'Sensor.loc_side'
        db.delete_column('feed_sensor', 'loc_side_id')
        
        # Deleting field 'Channel.units'
        db.delete_column('feed_channel', 'units_id')
