...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Study.resources'
        db.add_column('feed_study', 'resources', orm['feed.study:resources'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Study.resources'
        db.delete_column('feed_study', 'resources')
