...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnatomicalLocation'
        db.create_table('feed_anatomicallocation', (
            ('id', orm['feed.anatomicallocation:id']),
            ('created_by', orm['feed.anatomicallocation:created_by']),
            ('created_at', orm['feed.anatomicallocation:created_at']),
            ('updated_at', orm['feed.anatomicallocation:updated_at']),
            ('label', orm['feed.anatomicallocation:label']),
            ('controlled', orm['feed.anatomicallocation:controlled']),
            ('deprecated', orm['feed.anatomicallocation:deprecated']),
            ('category', orm['feed.anatomicallocation:category']),
            ('tmp_muscleid', orm['feed.anatomicallocation:tmp_muscleid']),
        ))
        db.send_create_signal('feed', ['AnatomicalLocation'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'AnatomicalLocation'
        db.delete_table('feed_anatomicallocation')
