...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MuscleOwl.synonyms_comma_separated'
        db.add_column(u'feed_muscleowl', 'synonyms_comma_separated',
                      self.gf('django.db.models.fields.CharField')(max_length=1500, null=True),
                      keep_default=False)

        # Adding field 'BehaviorOwl.synonyms_comma_separated'
        db.add_column(u'feed_behaviorowl', 'synonyms_comma_separated',
                      self.gf('django.db.models.fields.CharField')(max_length=1500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MuscleOwl.synonyms_comma_separated'
        db.delete_column(u'feed_muscleowl', 'synonyms_comma_separated')

        # Deleting field 'BehaviorOwl.synonyms_comma_separated'
        db.delete_column(u'feed_behaviorowl', 'synonyms_comma_separated')
