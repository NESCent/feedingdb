...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmgChannel.emg_amplification'
        db.add_column('feed_emgchannel', 'emg_amplification', orm['feed.emgchannel:emg_amplification'])
        
        # Adding field 'EmgElectrode.emg_amplification'
        db.add_column('feed_emgelectrode', 'emg_amplification', orm['feed.emgelectrode:emg_amplification'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'EmgChannel.emg_amplification'
        db.delete_column('feed_emgchannel', 'emg_amplification')
        
        # Deleting field 'EmgElectrode.emg_amplification'
        db.delete_column('feed_emgelectrode', 'emg_amplification')
