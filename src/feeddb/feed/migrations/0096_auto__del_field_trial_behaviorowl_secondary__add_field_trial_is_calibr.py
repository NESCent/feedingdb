...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trial.is_calibration'
        db.add_column(u'feed_trial', 'is_calibration',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Trial.is_calibration'
        db.delete_column(u'feed_trial', 'is_calibration')
