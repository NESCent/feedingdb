...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StudyPrivate.lab'
        db.delete_column(u'feed_studyprivate', 'lab')

        # Deleting field 'StudyPrivate.approval'
        db.delete_column(u'feed_studyprivate', 'approval')

        # Deleting field 'StudyPrivate.funding'
        db.delete_column(u'feed_studyprivate', 'funding')

        # Deleting field 'StudyPrivate.organization'
        db.delete_column(u'feed_studyprivate', 'organization')

        # Deleting field 'StudyPrivate.pi'
        db.delete_column(u'feed_studyprivate', 'pi')


    def backwards(self, orm):
        # Adding field 'StudyPrivate.lab'
        db.add_column(u'feed_studyprivate', 'lab',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StudyPrivate.approval'
        db.add_column(u'feed_studyprivate', 'approval',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StudyPrivate.funding'
        db.add_column(u'feed_studyprivate', 'funding',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StudyPrivate.organization'
        db.add_column(u'feed_studyprivate', 'organization',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StudyPrivate.pi'
        db.add_column(u'feed_studyprivate', 'pi',
