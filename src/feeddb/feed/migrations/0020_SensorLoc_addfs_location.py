...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SonoSensor.location_controlled'
        db.add_column('feed_sonosensor', 'location_controlled', orm['feed.sonosensor:location_controlled'])
        
        # Adding field 'Sensor.location_freetext'
        db.add_column('feed_sensor', 'location_freetext', orm['feed.sensor:location_freetext'])
        
        # Adding field 'EmgSensor.location_controlled'
        db.add_column('feed_emgsensor', 'location_controlled', orm['feed.emgsensor:location_controlled'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SonoSensor.location_controlled'
        db.delete_column('feed_sonosensor', 'location_controlled_id')
        
        # Deleting field 'Sensor.location_freetext'
        db.delete_column('feed_sensor', 'location_freetext')
        
        # Deleting field 'EmgSensor.location_controlled'
        db.delete_column('feed_emgsensor', 'location_controlled_id')
    ...
    models = {
        ...
        'feed.sensor': {
            ...
            'location_freetext': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'setup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Setup']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
