...
class Migration:
    ...
    def forwards(self, orm):
        for muscle in orm.Muscle.objects.all():
            anatloc = AnatomicalLocation()
            anatloc.label = muscle.label
            anatloc.category = AnatomicalCategories.muscle
            anatloc.tmp_muscleid = muscle.id
            anatloc.save()
    
    
    def backwards(self, orm):
        for anatloc in orm.AnatomicalLocation.objects.all():
            anatloc.delete()
