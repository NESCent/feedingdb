...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChannelLineup.channel'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Channel'], null=True, blank=True))
        db.alter_column('feed_channellineup', 'channel_id', orm['feed.channellineup:channel'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ChannelLineup.channel'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['feed.Channel']))
        db.alter_column('feed_channellineup', 'channel_id', orm['feed.channellineup:channel'])
