...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.title'
        db.add_column('feed_session', 'title', orm['feed.session:title'])
        
        # Adding field 'Study.title'
        db.add_column('feed_study', 'title', orm['feed.study:title'])
        
        # Adding field 'Trial.title'
        db.add_column('feed_trial', 'title', orm['feed.trial:title'])
        
        # Adding field 'Experiment.title'
        db.add_column('feed_experiment', 'title', orm['feed.experiment:title'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Session.title'
        db.delete_column('feed_session', 'title')
        
        # Deleting field 'Study.title'
        db.delete_column('feed_study', 'title')
        
        # Deleting field 'Trial.title'
        db.delete_column('feed_trial', 'title')
        
        # Deleting field 'Experiment.title'
        db.delete_column('feed_experiment', 'title')
    ...
    models = {
        ...
        'feed.experiment': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'new Experiment - edit this'", 'max_length': '255'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'new Experiment - edit this'", 'max_length': '255', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
        },
        'feed.illustration': {
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'feed.session': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'new Recording Session - edit this'", 'max_length': '255'}),
            'position': ('django.db.models.fields.IntegerField', [], {}),
            'start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'new Recording Session - edit this'", 'max_length': '255', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {})
        },
        'feed.setup': {
            'created_at': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'feed.trial': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'new Trial - edit this'", 'max_length': '255'}),
            'position': ('django.db.models.fields.IntegerField', [], {}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Session']"}),
            'start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'subj_notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'subj_treatment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'new Trial - edit this'", 'max_length': '255', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {}),
