...
class Migration:
    ...
    def forwards(self, orm):
        years_unit = orm.AgeUnit.objects.get(label__iexact = 'years')
        
        aged_experiments = orm.Experiment.objects.exclude(subj_age__isnull = True)
        for e in aged_experiments:
            e.subj_ageunit = years_unit
            e.save()
    
    
    def backwards(self, orm):
        "Write your backwards migration here"
        for e in orm.Experiment.objects.all():
            e.subj_ageunit = None
            e.save()
