...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StrainChannel.unit'
        db.add_column('feed_strainchannel', 'unit', orm['feed.strainchannel:unit'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StrainChannel.unit'
        db.delete_column('feed_strainchannel', 'unit_id')
