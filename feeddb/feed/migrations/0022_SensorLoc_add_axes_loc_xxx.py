...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MedialLateralAxis'
        db.create_table('feed_mediallateralaxis', (
            ('id', orm['feed.mediallateralaxis:id']),
            ('created_by', orm['feed.mediallateralaxis:created_by']),
            ('created_at', orm['feed.mediallateralaxis:created_at']),
            ('updated_at', orm['feed.mediallateralaxis:updated_at']),
            ('label', orm['feed.mediallateralaxis:label']),
            ('controlled', orm['feed.mediallateralaxis:controlled']),
            ('deprecated', orm['feed.mediallateralaxis:deprecated']),
        ))
        db.send_create_signal('feed', ['MedialLateralAxis'])
        
        # Adding model 'ProximalDistalAxis'
        db.create_table('feed_proximaldistalaxis', (
            ('id', orm['feed.proximaldistalaxis:id']),
            ('created_by', orm['feed.proximaldistalaxis:created_by']),
            ('created_at', orm['feed.proximaldistalaxis:created_at']),
            ('updated_at', orm['feed.proximaldistalaxis:updated_at']),
            ('label', orm['feed.proximaldistalaxis:label']),
            ('controlled', orm['feed.proximaldistalaxis:controlled']),
            ('deprecated', orm['feed.proximaldistalaxis:deprecated']),
        ))
        db.send_create_signal('feed', ['ProximalDistalAxis'])
        
        # Adding field 'Sensor.loc_ap'
        db.add_column('feed_sensor', 'loc_ap', orm['feed.sensor:loc_ap'])
        
        # Adding field 'Sensor.loc_ml'
        db.add_column('feed_sensor', 'loc_ml', orm['feed.sensor:loc_ml'])
        
        # Adding field 'Sensor.loc_pd'
        db.add_column('feed_sensor', 'loc_pd', orm['feed.sensor:loc_pd'])
        
        # Adding field 'Sensor.loc_dv'
        db.add_column('feed_sensor', 'loc_dv', orm['feed.sensor:loc_dv'])
        
        # Deleting field 'Sensor.loc_region'
        db.delete_column('feed_sensor', 'loc_region')
        
        # Changing field 'Sensor.location_freetext'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('feed_sensor', 'location_freetext', orm['feed.sensor:location_freetext'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'MedialLateralAxis'
        db.delete_table('feed_mediallateralaxis')
        
        # Deleting model 'ProximalDistalAxis'
        db.delete_table('feed_proximaldistalaxis')
        
        # Deleting field 'Sensor.loc_ap'
        db.delete_column('feed_sensor', 'loc_ap_id')
        
        # Deleting field 'Sensor.loc_ml'
        db.delete_column('feed_sensor', 'loc_ml_id')
        
        # Deleting field 'Sensor.loc_pd'
        db.delete_column('feed_sensor', 'loc_pd_id')
        
        # Deleting field 'Sensor.loc_dv'
        db.delete_column('feed_sensor', 'loc_dv_id')
        
        # Adding field 'Sensor.loc_region'
        db.add_column('feed_sensor', 'loc_region', orm['feed.sensor:loc_region'])
    ...
    models = {
        ...
        'feed.anatomicallocation': {
            ...
            'tmp_muscleid': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        'feed.emgsensor': {
            ...
            'axisdv': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.DorsalVentralAxis']", 'null': 'True', 'blank': 'True'}),
            'electrode_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.ElectrodeType']", 'null': 'True', 'blank': 'True'}),
            'location_controlled': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.AnatomicalLocation']", 'null': 'True'}),
            'muscle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Muscle']"}),
