...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('feed_trial', 'name', orm['feed.trial:name'], keep_default=False)
        
        # Adding field 'Experiment.name'
        db.add_column('feed_experiment', 'name', orm['feed.experiment:name'], keep_default=False)
        
        # Adding field 'Session.name'
        db.add_column('feed_session', 'name', orm['feed.session:name'], keep_default=False)
